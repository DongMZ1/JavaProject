...
public class TwoGoldForFiveWPEventCardHandler implements MinuetoKeyboardHandler,
MinuetoMouseHandler,
MinuetoWindowHandler{
	...
	public TwoGoldForFiveWPEventCardHandler() {
		...
		fontArial19 = new MinuetoFont("Arial",19,false, false);
			...
			imageText = new MinuetoText("Press 1 to Trade two Gold for Another 5 Willpower!;" ,fontArial19,MinuetoColor.BLUE);
