...
//        this.screen = screen;
    ...
    static {
    	...
    	TILES.add(new Tile(6532, 3538, 32, new int[] {16, 38}, 16));
    	...
    	TILES.add(new Tile(6536, 3528, 38, new int[] {16, 28, 32, 36, 39}, 16));
    	TILES.add(new Tile(2416, 5880, 39, new int[] {38, 40, 42, 43}, 38));
    	TILES.add(new Tile(1764, 6384, 40, new int[] {39, 41}, 39));
    	TILES.add(new Tile(4880, 4520, 41, new int[] {37, 40}, 40)); 	
    	TILES.add(new Tile(6312, 4728, 42, new int[] {39, 43, 44, 45}, 39));
    	TILES.add(new Tile(7488, 5604, 43, new int[] {39, 42, 44, 45, 71}, 39));   	
    	TILES.add(new Tile(5716, 6028, 44, new int[] {42, 43, 45, 46}, 42));
    	TILES.add(new Tile(4548, 6544, 45, new int[] {43, 44, 46, 64, 65}, 43));
    	TILES.add(new Tile(7668, 4546, 46, new int[] {44, 45, 47, 64}, 44));
    	TILES.add(new Tile(8624, 5280, 47, new int[] {48, 53, 54, 56}, 46));
    	TILES.add(new Tile(7912, 4184, 48, new int[] {16, 47, 49, 50, 51, 53}, 16));
    	TILES.add(new Tile(7912, 4260, 49, new int[] {48, 50}, 48));
    	TILES.add(new Tile(9440, 4260, 50, new int[] {48, 49, 51, 52}, 48));
    	TILES.add(new Tile(8028, 3544, 51, new int[] {48, 50, 52, 53, 55}, 48));   	
    	TILES.add(new Tile(7980, 2600, 52, new int[] {50, 51, 55}, 50));
    	TILES.add(new Tile(6644, 2184, 53, new int[] {47, 48, 51, 54, 55}, 47));
    	TILES.add(new Tile(5356, 1492, 54, new int[] {47, 53, 55, 56, 57}, 47));
    	TILES.add(new Tile(7632, 1192, 55, new int[] {51, 52, 53, 54, 57}, 51));   	
    	TILES.add(new Tile(6768, 736, 56, new int[] {47, 54, 57, 63}, 47));
    	TILES.add(new Tile(9076, 1800, 57, new int[] {54, 55, 56, 58, 59, 63}, 54));   	
    	TILES.add(new Tile(8852, 1752, 58, new int[] {57, 59, 60, 61, 62, 63}, 57));
    	TILES.add(new Tile(8104, 632, 59, new int[] {57, 58, 60}, 57));
